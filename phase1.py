...
with open('phase1.csv', 'w', newline='') as csvfile:
 ...
 #help===writer.writerow([product_page_url, universal_product_code, ...]),=== data = [product_page_url, universal_product_code, ...]writer.writerow([product_page_url, universal_product_code, ...])
